...
class UpdatePlaylistUnauthorized(PlexAPIError):
    r"""Unauthorized - Returned if the X-Plex-Token is missing from the header or query."""

    data: UpdatePlaylistUnauthorizedData = field(hash=False)
...
@dataclass(frozen=True)
class UpdatePlaylistBadRequest(PlexAPIError):
    r"""Bad Request - A parameter was not specified, or was specified incorrectly."""

    data: UpdatePlaylistBadRequestData = field(hash=False)
