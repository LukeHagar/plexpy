...
class UploadPlaylistUnauthorized(PlexAPIError):
    r"""Unauthorized - Returned if the X-Plex-Token is missing from the header or query."""

    data: UploadPlaylistUnauthorizedData = field(hash=False)
...
@dataclass(frozen=True)
class UploadPlaylistBadRequest(PlexAPIError):
    r"""Bad Request - A parameter was not specified, or was specified incorrectly."""

    data: UploadPlaylistBadRequestData = field(hash=False)
