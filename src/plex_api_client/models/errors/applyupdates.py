...
class ApplyUpdatesUpdaterErrorsTypedDict(TypedDict):
    code: NotRequired[int]
    message: NotRequired[str]
    status: NotRequired[int]


class ApplyUpdatesUpdaterErrors(BaseModel):
...
class ApplyUpdatesUnauthorized(PlexAPIError):
    ...
    data: ApplyUpdatesUnauthorizedData = field(hash=False)
...
class ApplyUpdatesErrors(BaseModel):
    code: Optional[int] = None
...
class ApplyUpdatesBadRequest(PlexAPIError):
    ...
    data: ApplyUpdatesBadRequestData = field(hash=False)
