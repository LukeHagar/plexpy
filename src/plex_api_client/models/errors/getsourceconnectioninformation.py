...
class GetSourceConnectionInformationAuthenticationErrorsTypedDict(TypedDict):
    code: NotRequired[int]
    message: NotRequired[str]
    status: NotRequired[int]


class GetSourceConnectionInformationAuthenticationErrors(BaseModel):
...
class GetSourceConnectionInformationUnauthorized(PlexAPIError):
    ...
    data: GetSourceConnectionInformationUnauthorizedData = field(hash=False)
...
class GetSourceConnectionInformationErrors(BaseModel):
    code: Optional[int] = None
...
class GetSourceConnectionInformationBadRequest(PlexAPIError):
    ...
    data: GetSourceConnectionInformationBadRequestData = field(hash=False)
