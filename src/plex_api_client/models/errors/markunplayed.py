...
class MarkUnplayedUnauthorized(PlexAPIError):
    r"""Unauthorized - Returned if the X-Plex-Token is missing from the header or query."""

    data: MarkUnplayedUnauthorizedData = field(hash=False)
...
@dataclass(frozen=True)
class MarkUnplayedBadRequest(PlexAPIError):
    r"""Bad Request - A parameter was not specified, or was specified incorrectly."""

    data: MarkUnplayedBadRequestData = field(hash=False)
