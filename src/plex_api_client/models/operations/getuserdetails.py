...
class GetUserDetailsStatus(str, Enum):
    ONLINE = "online"
    OFFLINE = "offline"
...
class GetUserDetailsAuthenticationStatus(str, Enum):
...
class SubscriptionTypedDict(TypedDict):
    ...
    status: NotRequired[GetUserDetailsAuthenticationStatus]
    r"""String representation of subscriptionActive"""
...
class Subscription(BaseModel):
    ...
    status: Optional[GetUserDetailsAuthenticationStatus] = None
    r"""String representation of subscriptionActive"""
...
class GetUserDetailsFeatures(str, Enum):
    ANDROID_DOLBY_VISION = "Android - Dolby Vision"
    ANDROID_PI_P = "Android - PiP"
    CU_SUNSET = "CU Sunset"
    HRK_ENABLE_EUR = "HRK_enable_EUR"
...
class GetUserDetailsAuthenticationResponseStatus(str, Enum):
    r"""String representation of subscriptionActive"""
...
class GetUserDetailsSubscriptionTypedDict(TypedDict):
    features: NotRequired[List[GetUserDetailsFeatures]]
    r"""List of features allowed on your Plex Pass subscription"""
    active: NotRequired[bool]
    r"""If the account's Plex Pass subscription is active"""
    subscribed_at: NotRequired[Nullable[str]]
    r"""Date the account subscribed to Plex Pass"""
    status: NotRequired[GetUserDetailsAuthenticationResponseStatus]
    r"""String representation of subscriptionActive"""
    payment_service: NotRequired[Nullable[str]]
    r"""Payment service used for your Plex Pass subscription"""
    plan: NotRequired[Nullable[str]]
...
class GetUserDetailsSubscription(BaseModel):
    features: Optional[List[GetUserDetailsFeatures]] = None
    r"""List of features allowed on your Plex Pass subscription"""
    ...
    status: Optional[GetUserDetailsAuthenticationResponseStatus] = None
    r"""String representation of subscriptionActive"""
...
class GetUserDetailsUserPlexAccountTypedDict(TypedDict):
    ...
    subscriptions: List[GetUserDetailsSubscriptionTypedDict]
    thumb: str
...
class GetUserDetailsUserPlexAccount(BaseModel):
    r"""Logged in user details"""
    ...
    subscriptions: List[GetUserDetailsSubscription]
...
class GetUserDetailsResponseTypedDict(TypedDict):
    content_type: str
    ...
    user_plex_account: NotRequired[GetUserDetailsUserPlexAccountTypedDict]
    r"""Logged in user details"""
...
class GetUserDetailsResponse(BaseModel):
    ...
    user_plex_account: Optional[GetUserDetailsUserPlexAccount] = None
    r"""Logged in user details"""
