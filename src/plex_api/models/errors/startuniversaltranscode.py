...
class StartUniversalTranscodeResponseBody(Exception):
    ...
    errors: Optional[List[StartUniversalTranscodeErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
