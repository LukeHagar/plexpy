...
@dataclasses.dataclass
class GetTokenResponseBody(Exception):
    r"""X-Plex-Client-Identifier is missing"""
    errors: Optional[List[GetTokenErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
