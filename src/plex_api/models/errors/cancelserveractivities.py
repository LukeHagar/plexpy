...
class CancelServerActivitiesResponseBody(Exception):
    ...
    errors: Optional[List[CancelServerActivitiesErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
