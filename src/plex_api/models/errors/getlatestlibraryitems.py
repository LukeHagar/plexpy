...
@dataclasses.dataclass
class GetLatestLibraryItemsResponseBody(Exception):
    r"""Unauthorized - Returned if the X-Plex-Token is missing from the header or query."""
    errors: Optional[List[GetLatestLibraryItemsErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
