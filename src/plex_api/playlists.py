...
class Playlists:
    ...
    def update_playlist(self, playlist_id: float) -> operations.UpdatePlaylistResponse:
        r"""Update a Playlist
    ...
    def add_playlist_contents(self, playlist_id: float, uri: str, play_queue_id: float) -> operations.AddPlaylistContentsResponse:
