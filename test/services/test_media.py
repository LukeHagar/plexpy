...
class TestMedia_(unittest.TestCase):
    ...
    def test_mark_played(self):
        ...
        response = test_service.mark_played(2)
    ...
    def test_mark_unplayed(self):
        ...
        # call the method to test
        test_service = Media("testkey")
        response = test_service.mark_unplayed(6)
        self.assertEqual(response.data, {})
        responses.reset(),
    ...
    def test_update_play_progress(self):
        ...
        # call the method to test
        test_service = Media("testkey")
        response = test_service.update_play_progress("quod", 4, "debitis")
        self.assertEqual(response.data, {})
        responses.reset(),
    ...
    def test_update_play_progress_error_on_non_200(self):
        ...
        with self.assertRaises(ClientException):
            test_service = Media("testkey")
            test_service.update_play_progress("reprehenderit", 6, "quo")
        responses.reset()
